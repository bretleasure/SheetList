...
namespace CAP.Apps.SheetList
{
	public class AddinGlobal
	{
		...
		public static string AppFolder = Tools.GetAppFolder("CAP.Apps.SheetList");

		public static string SettingsFile = Tools.GetHexString("CAP.Apps.SheetList Settings") + ".xml";
